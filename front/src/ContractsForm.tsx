...
const ContractInput: React.FC<ContractInputProps> = ({ contract, onUpdate }) => {
  const handleFeeChange = (value: string): void => {
  ...
  return (
    <>
      ...
      <tr>
        ...
        <td className="va-baseline">c/kWh</td>
      </tr>
      <tr>
        <td className="px-s">
...
const ContractsForm: React.FC<ContractFormProps> = ({
  ...
  const handleContractUpdate = (index: number, updatedContract: Contract): void => {
